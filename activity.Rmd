...
The Mean number of steps each day is `r data_mean`.
The Median steps each day is `r data_median`.
...
The 5-minute interval with the most steps on average is `r max_steps`.
...
The Mean number of steps each day is `r data3_mean`.
The Median steps each day is `r data3_median`.
